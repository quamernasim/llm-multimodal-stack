"""
Health check functionality for text-to-image service.
"""
import logging
import torch
from typing import Dict, Any

from config.constants import APP_NAME, MODEL_NAME
    ...
    def get_health_status(self) -> Dict[str, Any]:
        ...
        try:
            health_info = {
                ...
                "cpu_offload_enabled": settings.enable_cpu_offload,
    ...
    def _get_cuda_info(self) -> Dict[str, Any]:
        ...
        try:
            return {
                ...
                "cuda_memory_total": f"{torch.cuda.get_device_properties(0).total_memory / 1024**3:.2f} GB"
            }
        except Exception as e:
